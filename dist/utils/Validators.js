...
exports.valitatorVS = exports.registerVS = exports.loginVS = void 0;
const express_validator_1 = require("express-validator");
const passwordVS = (0, express_validator_1.body)('password').escape().exists().withMessage("Password required").isString().withMessage('Password must be string').isLength({ min: 3 })
